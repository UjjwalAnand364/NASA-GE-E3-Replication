...
C   SET THE DEFAULT INTEGERS
      NMAX   = 25000 ! MAXIMUM NUMBER OF TIME STEPS
...
C
      ...
      DAMP    = 20.   !  DAMPING FACTOR FOR NEGATIVE FEEDBACK
...
C
     ...
     &                DENSTY
C
C     Edit by GSingh 10/10/2017 Setting F_PDOWN=0.1
      WRITE(10,*)  '    CFL,    DAMP,    MACHLIM,    F_PDOWN '
      WRITE(10,1700) CFL, DAMP, MACHLIM, 0.1
C
      WRITE(10,*)   ' IF_RESTART '
...
C
      ...
      WRITE(10,1703) (5000+(N-1)*5000,N=1,5)
...
C
      IF(ILOS.GE.200)THEN
           WRITE(4,1700) FAC_STMIX, FAC_ST0, FAC_ST1,
