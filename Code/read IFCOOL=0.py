...
RO, ROVX, ROVR, ROVT, ROE = read_flow_out("Other files/flow_out_design0")
X2D, R2D, RTHETA, NBLADE = read_grid_out("Other files/grid_out_design0")
...
outfile = f"Output/Updated/IFCOOL = 0/multall_K{K_output+1}.txt"
